...
| Skills, prompt templates, and slash resolution behavior | `conformance/extract/f8-slash-templates.ts`, `conformance/fixtures/F8/`, `conformance/runner/f8_slash_templates_test.go` | WP-340 |
