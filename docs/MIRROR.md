...
| `packages/coding-agent/src/modes/rpc/`, `packages/coding-agent/test/{rpc-jsonl,rpc-client-clone,rpc-client-process-exit,rpc-prompt-response-semantics,rpc}.test.ts`, regression `5868-rpc-unknown-command-id.test.ts` | `cmd/pi/conformance_{disabled,enabled}.go`, `conformance/extract/f7-rpc.ts`, `conformance/extract/f7-rpc-host.ts`, `conformance/extract/run-upstream-rpc-tests.ts`, `conformance/fixtures/F7/`, `conformance/runner/f7_rpc_test.go` | WP-331 |
...
| `packages/coding-agent/src/core/{resource-loader,package-manager,settings-manager,system-prompt}.ts`, `packages/coding-agent/src/cli/args.ts` (skills/prompts subset) | `codingagent/resources.go`, `codingagent/config/settings.go`, `codingagent/system_prompt.go`, `cmd/pi/args.go`, `cmd/pi/runtime.go`, `cmd/pi/main.go` | WP-340 |
