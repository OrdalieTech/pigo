...
| `packages/coding-agent/src/core/agent-session-runtime.ts`, `packages/coding-agent/src/{main,rpc-entry}.ts` | `cmd/pi/rpc_host.go`, `cmd/pi/rpc_host_test.go`, `cmd/pi/main.go`, `cmd/pi/main_test.go`, `cmd/pi/runtime.go`, `cmd/pi/runtime_test.go` | WP-331 |
