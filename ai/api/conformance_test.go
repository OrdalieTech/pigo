...
func TestF2OpenAIRequestShaping(t *testing.T) {
	...
	for _, fixtureCase := range fixture.Cases {
		t.Run(fixtureCase.Name, func(t *testing.T) {
			...
			gotHeaders := selectedF2Headers(captured.Headers)
...
func runF2Case(t *testing.T, fixtureCase f2Case, fixtureResponse f2HTTPResponse) (capturedOpenAIRequest, []json.RawMessage) {
	t.Helper()
...
func selectedF2Headers(headers http.Header) map[string]string {
	names := []string{
		"authorization",
		"content-type",
		"session_id",
