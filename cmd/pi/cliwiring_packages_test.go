...
// Finding 2: extensions provided by installed pi packages must load. cmd/pi now
...
// inlineNpmRegistry is a compact offline npm registry for cmd/pi package tests.
